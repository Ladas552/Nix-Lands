{ types, ... }: {
  ...
  options = {
    ...
    initLua = {
      type = types.pathLike;
      default = "/home/ladas552/Projects/my_repos/Nix-Lands/pkgs/adios-wrappers/neovim/nvim/init.lua";
      description = ''
    ...
    startPlugins = {
      ...
      description = ''
        ...
        If a path is a string, it will be loaded at runtime instead of at build
        time allowing for hot-reloading.
      '';
      example = ''
        {
    ...
    treesitterPackage = {
      type = types.derivation;
      defaultFunc = { inputs }: inputs.nixpkgs.pkgs.vimPlugins.nvim-treesitter.withAllGrammars;
      description = ''
  ...
  environment = {
    XDG_CONFIG_HOME = "/home/ladas552/Projects/my_repos/Nix-Lands/pkgs/adios-wrappers/neovim/";
  };
